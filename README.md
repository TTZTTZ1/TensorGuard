<p align="center">
  <img src="assets/readme/tensorguard-hero.svg" alt="TensorGuard - 深度学习框架智能模糊测试与缺陷验证平台" width="100%">
</p>
...
**[系统架构](#系统架构)** · **[核心创新](#七项核心创新)** · **[界面展示](#界面展示)** · **[快速开始](#快速开始)** · **[项目结构](#项目结构)**
...
<p align="center">
  <img src="assets/readme/tensorguard-architecture.svg" alt="TensorGuard 技术路线：约束知识、种子生成、进化变异、差分检测与证据归档" width="100%">
</p>

完整数据链路为：

> **核心链路：** 约束蒸馏 → 种子生成 → 质量修复 → 有效种子池 → 进化变异 → 执行分类 → 差分检测 → 候选复核 → 证据归档
